...
>
  ...
  <div className="absolute inset-0 flex flex-col justify-end mb-5 px-10 md:px-20 text-white">
    ...
    We understand the unique challenges bachelors face when searching for a home. Our platform is designed to<br/>
       simplify the process, offering reliable, verified options tailored to your needs. With a commitment to transparency 
       <br/>and trust, we ensure you find the perfect space to call your own.
    </p>
    <div className="mt-4 self-start">
    <button
    onClick={() => {navigate("/housinghome");}
    }
        type="submit"
  ...
  >
    ...
    <div className="absolute inset-0 flex flex-col justify-end mb-5 px-10 md:px-20 text-white">
      <h1 className="text-4xl md:text-5xl font-bold">
      Healthy and Tasty Home Food Options
      </h1>
      <p className="mt-4 text-lg md:text-xl">
 ...
 {/* Slide 3 */}
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-l from-black via-transparent to-transparent"></div>
    <div className="absolute inset-0 flex flex-col justify-end mb-5 px-10 md:px-20 text-white">
      <h1 className="text-4xl md:text-5xl font-bold">Perfects Events to Spend your time 
      </h1>
      <p className="mt-4 text-lg md:text-xl">
      We understand the unique challenges bachelors face when searching for a home. Our platform is designed to<br/>
       simplify the process, offering reliable, verified options tailored to your needs. With a commitment to transparency 
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-l from-black via-transparent to-transparent"></div>
    <div className="absolute inset-0 flex flex-col justify-end mb-5 px-10 md:px-20 text-white">
      <h1 className="text-4xl md:text-5xl font-bold">Find things at perfect cost
      </h1>
      <p className="mt-4 text-lg md:text-xl">
      We understand the unique challenges bachelors face when searching for a home. Our platform is designed to<br/>
       simplify the process, offering reliable, verified options tailored to your needs. With a commitment to transparency 
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-l from-black via-transparent to-transparent"></div>
    <div className="absolute inset-0 flex flex-col justify-end mb-5 px-10 md:px-20 text-white">
      <h1 className="text-4xl md:text-5xl font-bold">Find latest part time jobs near you
      </h1>
      <p className="mt-4 text-lg md:text-xl">
      We understand the unique challenges bachelors face when searching for a home. Our platform is designed to<br/>
       simplify the process, offering reliable, verified options tailored to your needs. With a commitment to transparency 
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-l from-black via-transparent to-transparent"></div>
    <div className="absolute inset-0 flex flex-col justify-end mb-5 px-10 md:px-20 text-white">
      <h1 className="text-4xl md:text-5xl font-bold">All in one place to find gadgets at best price
      </h1>
      <p className="mt-4 text-lg md:text-xl">
      We understand the unique challenges bachelors face when searching for a home. Our platform is designed to<br/>
       simplify the process, offering reliable, verified options tailored to your needs. With a commitment to transparency 
