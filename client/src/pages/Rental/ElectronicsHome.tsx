...
const CATEGORY_NAME = "Electronics"; // Define category name for this page

const ElectronicsHome: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
              {CATEGORY_NAME} on Rent
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Upgrade your tech game with our latest electronics. Rent now and
              enjoy cutting-edge technology at affordable rates.
            </p>
          </div>
        </div>
      </div>
