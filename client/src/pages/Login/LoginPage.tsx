  ...
  const handleEmailPasswordLogin = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3000/user/login", {
        containerName: "Users", // Ensure this matches your backend setup
        email,
        password,
      });
      const { data } = response;
  ...
  <div className="w-1/2 flex items-start">
    <div className="text-left space-y-4">
      ...
      <p className="text-gray-700 text-lg">
        Join the largest community of bachelors in India. Connect, collaborate, 
        and create memories with like-minded individuals.
      </p>
    </div>
  </div>
